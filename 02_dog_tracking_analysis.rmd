...
pdf(file = "graphics/cor_mat.pdf", width = 12, height=6)
#jpeg(file = "graphics/cor_mat.jpg", width = 30, height=15, units="cm", res=1000)
corrplot(corr[13:16,],method="color",   pch.col = 'grey20', tl.col = 'black', addCoef.col = 'black')# p.mat = p.mat[13:16,], sig.level = c(0.001, 0.01, 0.05), pch.cex = 0.9, insig = 'label_sig',
...
```{r}
library(cowplot)
pg2<-plot_grid(distance.plot2, object.distance.plot2, area.plot2, vis.angle.owner.plot2, tail.plot2, tail.angle.plot , ncol=2,  labels=c("(a)", "(b)", "(c)", "(d)", "(e)", "(f)"), label_x = 0.15, label_y = 0.97, align = "vh")
...
library(cowplot)
pg3<-plot_grid(owner.duration.plot , stranger.duration.plot , door.duration.plot , nrow=1,  labels=c("(b)", "(c)", "(d)"), label_size = 20, label_x = 0.16, label_y = 0.99, align = "vh")
...
pg4<-plot_grid(p3, pg3, nrow=2,  labels=c("(a)", ""), rel_heights = c(1, 0.5), label_size = 20, label_x = 0.05, label_y = 0.96, align = "vh")

ggsave(pg4, filename = "graphics/dog_exploration_duration_pg4.png", width=11, height=13, scale=1.1)

ggsave(pg4, filename = "graphics/dog_exploration_duration_pg4.jpg", width=11, height=13, scale=1.1, dpi=1000)
```
...
library(cowplot)
#execute script in 01_dog_tracking_data_processing
pg5<-plot_grid(hs_plot2, cormat.all.tasks, labels = c("(b)", "(c)"), rel_widths = c(1,1.3), label_x = c(0.17, 0.2), label_y = 0.97, align = "t")
pg6<-plot_grid(p.example2, pg5, labels = c("(a)", ""), nrow=2, rel_heights = c(1,1.3), label_x = 0.06, label_y = 0.91)

ggsave(pg6, filename = "graphics/validation_pg.jpg", width=10, height=10, scale=0.8, dpi=1000)
